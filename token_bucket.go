...
import (
	...
	"github.com/iamalex5156/rlc/internal"
)

// A TokenBucket represents a rate limiter based on a custom implementation of the
// token bucket algorithm with a refill interval. Implements the rlc.Limiter
// interface.
//
...
// Verify TokenBucket satisfies the rlc.Limiter interface.
